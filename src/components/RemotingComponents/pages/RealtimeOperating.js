...
class RealtimeOperating extends React.Component {
  ...
  render() {
    ...
    return (
      <RemotingLayout headingcontent="Real Time Operating">
          ...
          <div className="col-md-9" ref={element => this.elemHeight = element} >
            ...
            <div className="row" style={{ marginLeft: '-8px', marginRight: '-11px' }}>
              <div id="dynamic-height-main" className="col-xs-12  col-sm-12 col-md-12"     >
                <RemotingParamTab    source="operating" getSize={this.handlesize} deviceId={device_id} msn_status={is_msn_active} />
              </div>
...
export default RealtimeOperating;
