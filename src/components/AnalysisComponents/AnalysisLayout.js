...
const AnalysisLayout = ({ children }) => (
  <div id="content" style={{ height: '1300px', overflowY: 'scroll'}}>
    <div className="page-title">
      <h1 style={{ position: 'unset', textTransform: 'none', paddingBottom: '10px'}}><i className="fa fa-line-chart fa-fw fa-md" />&nbsp;&nbsp;Analysis</h1>
    </div>
    {/*
