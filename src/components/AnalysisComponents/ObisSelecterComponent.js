...
class ObisSelecterComponent extends React.Component {
  ...
  componentWillReceiveProps(props) {
    const { obis_component_chk } = this.props;
    console.log("willreceivepropsbiscomponent");

    console.log(obis_component_chk);

    /////////new funtionality///////
    if(obis_component_chk == 'close'){
    this.setState({ value: [] });//vvimpsss
    }
    ///////////////////////////////
...
export default ObisSelecterComponent;
